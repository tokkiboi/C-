...
//	while (!myFileIn.eof()){
//	getline(myFileIn,state_name);
	cout << "\033[1;33mState_name:\t\t" << "\033[0m" << state_name << endl;
	myFileIn >> groceries >> housing >> utilities >> transportation >> health >> misc;
	myFileIn.get(ch);
//	myFileIn.ignore(100,ch);
//	myFileOut.open ("costIndex.txt",ios::app);
		...
		cout << "\033[1;32mComposite Index:\t" << "\033[0m" << c_index << endl;
//		cout << "State name:\t\t" << state_name << endl;
//		cout << "Composite Index:\t" << c_index << endl;
...
//                cout << "\033[1;32m" << "Composite Index:\t" << setw(5) << right << c_index;
...
void signature()
{
//ofstream myFileOut("costIndex.txt", ios::app);
