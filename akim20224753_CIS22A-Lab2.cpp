...
#include <string>
#include <iomanip>
// preprocessor declaration of state's sales tax if 5.5%
#define STATE_SALES_TAX 0.055 
using namespace std;
...
int main()
{
	...
	cout << setw(20) << left << "\n\nMonth:" << month << endl;
	cout << "-------------------------" << endl;
	cout << setw(20) << left << "Total Collected:" << "$ " << setw(10) << fixed << setprecision(2) << right << total_amount_collected << endl;
	cout << setw(20) << left << "Sales:" << "$ " << setw(10) << setprecision(2) << right << sales << endl;
	cout << setw(20) << left << "County Sales Tax:" << "$ " << setw(10) << setprecision(2) << right << ctax << endl;
	cout << setw(20) << left << "State Sales Tax:" << "$ " << setw(10) << setprecision(2) << right << stax << endl;
	cout << setw(20) << left << "Total Sales Tax:" << "$ " << setw(10) << setprecision(2) << right << ttax << endl;
	cout << setw(20) << left << "\nAlex Kim" << endl;
	system("pause");
	return 0;
}
...
Please enter the total amount collected at the cash register: 71998.67


Month: January
-------------------------
Total Collected: $   71998.67
Sales:       $   66789.12
County Sales Tax: $    1536.15
State Sales Tax: $    3673.40
Total Sales Tax: $    5209.55
