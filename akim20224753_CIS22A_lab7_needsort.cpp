...
//	cout << "\033[1;32mUniversity with the lowest tuition:\t" << min_university << endl;  // debug purpose (Testing) {for (int i=0; i < count;i++){     
	cout << setprecision(2) << fixed;
...
void compare_tuition(string university[],double tuition[],int count, double target_tuition)
{
	...
	cout << "\n\033[1;32mMaximum affordable tuition:\t" << target_tuition << endl;  // debug purpose (Testing)
...
Enter the affordable tuition: 40000
Maximum affordable tuition:	40000.00
